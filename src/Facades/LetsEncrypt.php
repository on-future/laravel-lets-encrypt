 ...
 * @method static array create(string $domain, array $chain = [], callable $catchCallback = null)
 ...
 * @method static PendingDispatch renew(string|LetsEncryptCertificate $domain, array $chain = [], callable $catchCallback = null)
